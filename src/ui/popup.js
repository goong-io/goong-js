 ...
 *   .setMaxWidth("300px")
 *   .addTo(map);
 * @see [Display a popup](https://https://docs.goong.io/example/popup/)
 * @see [Display a popup on hover](https://https://docs.goong.io/example/popup-on-hover/)
 * @see [Display a popup on click](https://https://docs.goong.io/example/popup-on-click/)
 * @see [Attach a popup to a marker instance](https://https://docs.goong.io/example/set-popup/)
 */
