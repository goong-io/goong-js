...
class FullscreenControl {
    ...
    _setupUI() {
        const button = this._fullscreenButton = DOM.create('button', (`goongjs-ctrl-fullscreen`), this._controlContainer);
        DOM.create('span', `goongjs-ctrl-icon`, button).setAttribute('aria-hidden', true);
        button.type = 'button';
        this._updateTitle();
    ...
    _changeIcon() {
        ...
        if ((fullscreenElement === this._container) !== this._fullscreen) {
            ...
            this._fullscreenButton.classList.toggle(`goongjs-ctrl-shrink`);
            this._fullscreenButton.classList.toggle(`goongjs-ctrl-fullscreen`);
            this._updateTitle();
        }
    }
